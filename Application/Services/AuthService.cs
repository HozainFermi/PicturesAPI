...
using Pictures.Application.Models.Abstractions;
using System;
...
{
    public class AuthService(IDKDbContext context, IConfiguration configuration, ICartService cartService) : IAuthService
    {
        private Guid cartId;
